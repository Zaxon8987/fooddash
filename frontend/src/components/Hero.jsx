    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-amber-50 min-h-[520px] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative w-full">
        <motion.div className="max-w-3xl mx-auto text-center" variants={stagger} initial="hidden" animate="visible">
          <motion.div variants={fadeDown} className="inline-flex items-center gap-2 bg-primary text-white px-4 py-1.5 rounded-full text-sm font-medium mb-6 shadow-sm shadow-primary/30">
          ...
          <motion.p variants={fadeUp} className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <motion.form variants={scaleIn} onSubmit={handleSubmit} className="max-w-xl mx-auto my-8">
            <div className="flex items-center bg-white rounded-full shadow-lg shadow-primary-glow border border-orange-100 p-1.5 group focus-within:border-primary focus-within:shadow-xl transition-all duration-300">
              ...
              <motion.button type="submit" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
                className="bg-primary hover:bg-primary-dark text-white px-7 py-2.5 rounded-lg font-medium transition text-sm shadow-sm shadow-orange-200">
                Search
              </motion.button>
            </div>
          </motion.form>
